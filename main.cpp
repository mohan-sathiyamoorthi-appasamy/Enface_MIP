#include "Header_OCTA_LayerMapping_MIP.h"
...
int Boundary1 = 0;
int Boundary2 = 3;
Mat image = OCT_A_LayerMapping_Filter_MIP(RegCSVLayerFolder, SVImageFolder, Boundary1,Boundary2,microns_value1,microns_value2);
imshow("Image", image);
waitKey(0);
}
